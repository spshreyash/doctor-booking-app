...
export const TopDoctors = () => {
 ...
 console.log(doctors," this is docotr object form home page ")

  return (
    <div className='flax flex-col items-center p-6 gap-4 text-gray-900 mt-5'>
     <h1 className='text-center font-semibold text-3xl sm:text-4xl '>Top Doctors to Book</h1>
     ...
     {   doctors.slice(0,5).map((itams,index)=>
     {
